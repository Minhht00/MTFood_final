...
public class TinyDB {
    ...
    public List<CartDetail> getListObject(String key){
        Gson gson = new Gson();

        List<String> objStrings = getListString(key);
        List<CartDetail> playerList =  new ArrayList<CartDetail>();

        for(String jObjString : objStrings){
            CartDetail player  = gson.fromJson(jObjString,  CartDetail.class);
    ...
    public void putListObject(String key, List<CartDetail> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(CartDetail player: playerList){
